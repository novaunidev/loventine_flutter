...
import '../animation/custom_translation_animation.dart';
                      ...
                      child: Transform.translate(
                        ...
                        child: Lottie.asset(
                          widget.action == "Payment"
                              ? "assets/lotties/face_id_scan.json"
                              : "assets/lotties/receive_money.json",
                          height: 280,
    ...
    if (index == 3) {
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Center(
              child: Image.asset(
            "assets/images/clear_symbol_bold.png",
            height: 28,
          )),
        ),
      );
