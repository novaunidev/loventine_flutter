...
enum Option { tucTiu, spam, anhSex, other }
  ...
  Future<void> createReport(String content) async {
    try {
      var response = await dio.post("$baseUrl/report/createReport", data: {
        ...
        'postBeingReported': widget.postId,
        'content': content,
                        ...
                        child: Align(
                          ...
                          child: TextButton(
                            ...
                            onPressed: () => {
                              ...
                              // createReport(),
                              if (_site == Option.tucTiu)
                                createReport(allRowContent[0].content),
                              if (_site == Option.spam)
                                createReport(allRowContent[1].content),
                              if (_site == Option.anhSex)
                                {
                                  createReport(allRowContent[2].content),
                                }
                              else
                                {
