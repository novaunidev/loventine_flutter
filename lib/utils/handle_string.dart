...
class HandleString {
  static String toLocalDateString(String utcString) {
    ...
    return formatted;
    // return '${dateLocal.hour}:${dateLocal.minute}:${dateLocal.second} - ${dateLocal.day}/${dateLocal.month}/${dateLocal.year}';
  }
  ...
  static String priceInPost(Post post) {
    /*
    - INSTRUCTION
      post = Post(
        id: 'p1',
    ...
    */
    ...
    if (post.isDate) res = '$res /ngày';
    if (post.isHour) res = '$res /giờ';
    if (post.isMonth) res = '$res /tháng';
    if (post.isYear) res = '$res /năm';
